...
namespace TextEditor
{
    public partial class MainWindow : Form
    {
        ...
        // Путь к компилятору.
        string compilerPath = @"C:\Windows\Microsoft.NET\Framework64\v4.0.30319\csc.exe";
        ...
        private void ToggleFontStyle(FontStyle fontStyle)
        {
            ...
            switch (fontStyle)
            {
                case FontStyle.Italic:
                    validation = activeTextBox.SelectionFont.Italic;
                    break;
                case FontStyle.Bold:
                    validation = activeTextBox.SelectionFont.Bold;
                    break;
                case FontStyle.Underline:
                    validation = activeTextBox.SelectionFont.Underline;
                    break;
                case FontStyle.Strikeout:
                    validation = activeTextBox.SelectionFont.Strikeout;
                    break;
            }
